...
<?php if (isset($_POST['contact_form'])) {
    ...
    <main class="front">
        ...
        <img class="star-bg" id="bg-stars-1"
             src="<?= get_stylesheet_directory_uri() . '/public/images/stars_layer_1.svg' ?>" alt="">
        <img class="star-bg" id="bg-stars-2"
             src="<?= get_stylesheet_directory_uri() . '/public/images/stars_layer_3.png' ?>" alt="">
